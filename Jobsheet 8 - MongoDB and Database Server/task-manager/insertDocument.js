// Mengimport modul MongoClient dan ObjectId dari 'mongodb'. const { MongoClient, ObjectId} = require('mongodb');
const {MongoClient, ObjectId} = require('mongodb');

// Mendefinisikan URL MongoDB server yang akan digunakan untuk koneksi. const url = 'mongodb://127.0.0.1:27017';
...
// Mencetak representasi hexadecimal dari ObjectId ke konsol. console.log(id.id);
console.log(id.id)
...
async function main() {
    try {
        ...
        // Memasukkan dokumen ke dalam koleksi 'pengguna. const insertPengguna await clPengguna.insertOne({
